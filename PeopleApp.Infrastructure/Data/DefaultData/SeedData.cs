...
namespace PeopleApp.Infrastructure.Data.DefaultData
{
    public static class SeedData
    {
        public static void SeedDatabase(IServiceScope scope)
        {
            ...
            PeopleAppDbContext context = provider.GetRequiredService<PeopleAppDbContext>();
            SeedPeopleData(context);
        }
        
        private static void SeedPeopleData(PeopleAppDbContext context)
        {
